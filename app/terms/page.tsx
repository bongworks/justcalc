...
export default function Terms() {
  return <PolicyPage page={page}>
    ...
    <h2>서비스 변경과 오류</h2>
    <p>계산식이나 서비스 제공 범위는 검토 결과에 따라 수정될 수 있습니다. 오류를 확인하면 <a href="/editorial-policy/">편집 및 검토 정책</a>에 따라 정정합니다. 이 안내는 관련 법령에 따른 이용자의 권리를 제한하지 않습니다.</p>
    <p>운영 정보와 문의 채널은 <a href="/contact/">운영 및 문의 안내</a>를 확인하세요. 현재는 공개 운영 준비 단계입니다.</p>
  </PolicyPage>;
}
