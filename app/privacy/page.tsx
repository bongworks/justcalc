...
export default function Privacy() {
  return <PolicyPage page={page}>
    ...
    <p>서비스가 분석에 사용하는 정보는 계산기 종류, 정해진 페이지 경로, 계산 기능 이용 여부와 복사 동작 여부로 한정됩니다. 숫자 입력, 계산 결과, 오류의 원문, 클립보드 내용과 주소의 쿼리·해시 값은 분석 정보에 포함하지 않습니다.</p>
    ...
    <h2>이메일 문의</h2>
    <p>문의 메일로 제공한 정보는 문의 확인과 답변을 위해서만 사용합니다. 문의 처리에 필요한 기간 동안 보관한 뒤 지체 없이 삭제하며, 법령에 따라 보관이 필요한 경우에는 해당 기간 동안 보관합니다.</p>
